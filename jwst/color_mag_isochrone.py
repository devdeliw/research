...
import itertools
from flystar import match, starlists, transforms, startables, align
import copy
import scipy.signal
...
class Isochrones: 
    ...
    def generate_isochrones(self): 
        ...
        dfy.to_csv(f"{self.iso_dir} + spisea_iso{file_name}.csv")
    ...
    def cmd_isochrones(self): 
        ...
        file_name = self.filt1_name + "-" + self.filt2_name + "_" + self.filt1_name
        ...
        file_name = self.filt1_name + "-" + self.filt2_name + "_" + self.filt2_name
        plt.savefig(f"{self.cmd_directory}" + f"{file_name}.png")
...
test2 = Isochrones(catalog1, catalog2, "jwst,F115W", "jwst,F212N", dr_tol = 15,
                  dm_tol = 15, logAge = np.log(10**9), AKs = 2, AKs_step = 0.3,
                  dist = 8000, metallicity = -0.3, mass = 10**5, 
                  iso_dir = "/Users/devaldeliwala/research/jwst/isochrones/", 
                  cmd_directory = "/Users/devaldeliwala/research/jwst/cmds/",
                  data_directory = "/Users/devaldeliwala/research/jwst/data/")

test2.generate_isochrones()
test2.synthetic_isochrones()
test2.cmd_isochrones()
