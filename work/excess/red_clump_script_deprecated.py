...
x_range_NRCB4 = { 
	'x1' : ['F115W', 'F212N', 'F323N', 'F405N'], 
	'F115W' : [None, [5, 9.5], [6, 10.2], [6.4, 11.6]], 
	'F212N' : [None, None, None, [1.2, 3]], 
	'F323N' : [None, None, None, [0.4, 3]]}
...
f115w_x1_f405n_x2 = { 
    ...
    'F405N' : [[(7.9, 13.3), (10.5, 13.8)], [(8.4, 13.9), (11, 14.4)]]}
...
for i in range(len(script)): 
	...
	if not os.path.isdir(image_path_riemann):
		os.makedirs(image_path_riemann)
	...
	#class_2.run(ns = [8, 9, 10, 11, 12, 13])
