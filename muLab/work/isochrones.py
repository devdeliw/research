...
class Isochrones:   
    ...
    def extinction_vector(self, catalog1, catalog2, 
        ...
        fig, axis2 = plt.subplots(1, 1, figsize = (20, 10))
        ...
        if matched == True: 
            ...
            my_iso = Isochrones.generate_isochrone(self, different_filt_list = different_filt_list)
            idx = np.where( abs(my_iso.points['mass'] - 1.0) == min(abs(my_iso.points['mass'] - 1.0)) )[0]

            self.AKs = AKs2
            my_iso2 = Isochrones.generate_isochrone(self, different_filt_list = different_filt_list)
            idx2 = np.where( abs(my_iso2.points['mass'] - 1.0) == min(abs(my_iso2.points['mass'] - 1.0)) )[0]

            self.AKs = AKs3
            my_iso3 = Isochrones.generate_isochrone(self, different_filt_list = different_filt_list)
            idx3 = np.where( abs(my_iso3.points['mass'] - 1.0) == min(abs(my_iso3.points['mass'] - 1.0)) )[0]

            self.AKs = AKs4
            my_iso4 = Isochrones.generate_isochrone(self, different_filt_list = different_filt_list)
            idx4 = np.where( abs(my_iso4.points['mass'] - 1.0) == min(abs(my_iso4.points['mass'] - 1.0)) )[0]

            self.AKs = AKs5
            my_iso5 = Isochrones.generate_isochrone(self, different_filt_list = different_filt_list)
            ...
            if catalogyname == catalog1name: 
                ...
                #plt.scatter(x, y, c = 'k', s = 0.8, alpha = 0.5)

                plt.plot(my_iso.points[''+my_iso.points.keys()[8]][np.where(my_iso.points['phase'] >= 100)] - my_iso.points[''+my_iso.points.keys()[9]][np.where(my_iso.points['phase'] >= 100)],
                         my_iso.points[''+my_iso.points.keys()[8]][np.where(my_iso.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso2.points[''+my_iso2.points.keys()[8]][np.where(my_iso2.points['phase'] >= 100)] - my_iso2.points[''+my_iso2.points.keys()[9]][np.where(my_iso2.points['phase'] >= 100)],
                         my_iso2.points[''+my_iso2.points.keys()[8]][np.where(my_iso2.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso3.points[''+my_iso3.points.keys()[8]][np.where(my_iso3.points['phase'] >= 100)] - my_iso3.points[''+my_iso3.points.keys()[9]][np.where(my_iso3.points['phase'] >= 100)],
                         my_iso3.points[''+my_iso3.points.keys()[8]][np.where(my_iso3.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso4.points[''+my_iso4.points.keys()[8]][np.where(my_iso4.points['phase'] >= 100)] - my_iso4.points[''+my_iso4.points.keys()[9]][np.where(my_iso4.points['phase'] >= 100)],
                         my_iso4.points[''+my_iso4.points.keys()[8]][np.where(my_iso4.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso5.points[''+my_iso5.points.keys()[8]][np.where(my_iso5.points['phase'] >= 100)] - my_iso5.points[''+my_iso5.points.keys()[9]][np.where(my_iso5.points['phase'] >= 100)],
                         my_iso5.points[''+my_iso5.points.keys()[8]][np.where(my_iso5.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                ...
                plt.axline((my_iso5.points[''+my_iso5.points.keys()[8]][idx5][0]
                            ...
                            my_iso.points[''+my_iso.points.keys()[8]][idx][0] + height), color = mcolors.CSS4_COLORS['tomato'], label = "extinction vector")

                y2_y1 = my_iso.points[''+my_iso.points.keys()[8]][idx][0] - my_iso5.points[''+my_iso5.points.keys()[8]][idx5][0]
                x2_x1 = (my_iso.points[''+my_iso.points.keys()[8]][idx][0] - my_iso.points[''+my_iso.points.keys()[9]][idx][0]) - (my_iso5.points[''+my_iso5.points.keys()[8]][idx5][0]
                            - my_iso5.points[''+my_iso5.points.keys()[9]][idx5][0])
            ...
            if catalogyname == catalog2name: 
                ...
                plt.plot(my_iso.points[''+my_iso.points.keys()[8]][np.where(my_iso.points['phase'] >= 100)] - my_iso.points[''+my_iso.points.keys()[9]][np.where(my_iso.points['phase'] >= 100)],
                         my_iso.points[''+my_iso.points.keys()[9]][np.where(my_iso.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso2.points[''+my_iso2.points.keys()[8]][np.where(my_iso2.points['phase'] >= 100)] - my_iso2.points[''+my_iso2.points.keys()[9]][np.where(my_iso2.points['phase'] >= 100)],
                         my_iso2.points[''+my_iso2.points.keys()[9]][np.where(my_iso2.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso3.points[''+my_iso3.points.keys()[8]][np.where(my_iso3.points['phase'] >= 100)] - my_iso3.points[''+my_iso3.points.keys()[9]][np.where(my_iso3.points['phase'] >= 100)],
                         my_iso3.points[''+my_iso3.points.keys()[9]][np.where(my_iso3.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso4.points[''+my_iso4.points.keys()[8]][np.where(my_iso4.points['phase'] >= 100)] - my_iso4.points[''+my_iso4.points.keys()[9]][np.where(my_iso4.points['phase'] >= 100)],
                         my_iso4.points[''+my_iso4.points.keys()[9]][np.where(my_iso4.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                plt.plot(my_iso5.points[''+my_iso5.points.keys()[8]][np.where(my_iso5.points['phase'] >= 100)] - my_iso5.points[''+my_iso5.points.keys()[9]][np.where(my_iso5.points['phase'] >= 100)],
                         my_iso5.points[''+my_iso5.points.keys()[9]][np.where(my_iso5.points['phase'] >= 100)], '-', label='_nolegend_', color = mcolors.CSS4_COLORS['tomato'])
                ...
                plt.axline((my_iso5.points[''+my_iso5.points.keys()[8]][idx5][0]
                            ...
                            (my_iso.points[''+my_iso.points.keys()[8]][idx][0]
                            - my_iso.points[''+my_iso.points.keys()[9]][idx][0],
                            my_iso.points[''+my_iso.points.keys()[9]][idx][0] + height), color = mcolors.CSS4_COLORS['tomato'], label = "extinction vector", linewidth = 2)

                y2_y1 = my_iso.points[''+my_iso.points.keys()[9]][idx][0] - my_iso5.points[''+my_iso5.points.keys()[9]][idx5][0]
                x2_x1 = (my_iso.points[''+my_iso.points.keys()[8]][idx][0] - my_iso.points[''+my_iso.points.keys()[9]][idx][0]) - (my_iso5.points[''+my_iso5.points.keys()[8]][idx5][0]
                            - my_iso5.points[''+my_iso5.points.keys()[9]][idx5][0])
